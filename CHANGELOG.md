...
* Pin GitHub Actions to immutable commits, scope workflow tokens, and run CodeQL directly on push/pull request rather
  than through a privileged `workflow_run` chain.
